...
module.exports = async function (jscode) {
  ...
  console.log('Restoring numerical values...')
  if (!decodeObject(ast)) {
    return null
  }
  console.log('Processing global encryption...')
  if (!decodeGlobal(ast)) {
    return null
  }
  console.log('Improving code readability...')
  ast = purifyCode(ast)
  console.log('Processing code block encryption...')
  stringArrayLite(ast)
  ast = decodeCodeBlock(ast)
  console.log('Cleaning dead code...')
  ...
  console.log('Improving code readability...')
  ast = purifyCode(ast)
  console.log('Removing environment restrictions...')
  ast = unlockEnv(ast)
